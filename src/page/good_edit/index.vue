<template>
  <div class="w-full bg-cover h-full p-2" style="background-image: url('/bg_deatied.png')">
    ...
    <div class="flex items-center flex-col">
      <n-input-group class="flex items-center mt-16  justify-center">
      ...
      <n-button-group style="width: 59%;" class="flex items-center mt-4">
        <div class="pingfang_jian mr-3 pl-6">商品价格</div>
      ...
      <div class="flex justify-end pr-32 w-95_">
        <n-button strong secondary class="mt-7 " @click="edit" type="info">提交</n-button>
      </div>
