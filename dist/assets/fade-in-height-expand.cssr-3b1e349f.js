import{a as $,s as f}from"./light-cdcf3c6d.js";const{cubicBezierEaseInOut:e,cubicBezierEaseOut:h,cubicBezierEaseIn:g}=f;function b({overflow:s="hidden",duration:t=".3s",originalTransition:i="",leavingDelay:n="0s",foldPadding:p=!1,enterToProps:c=void 0,leaveToProps:d=void 0,reverse:m=!1}={}){const a=m?"leave":"enter",o=m?"enter":"leave";return[$(`&.fade-in-height-expand-transition-${o}-from,
