...
`,[u(">",[c("input",[u("&:not(:last-child)",`
 ...
 border-top-left-radius: 0!important;
 border-bottom-left-radius: 0!important;
 `)])])])])])]),Ct={},wt=W({name:"InputGroup",props:Ct,setup(e){const{mergedClsPrefixRef:n}=Y(e);return Te("-input-group",yt,n),{mergedClsPrefix:n}},render(){const{mergedClsPrefix:e}=this;return p("div",{class:`${e}-input-group`},this.$slots)}}),d="0!important",Me="-1px!important";function L(e){return B(e+"-type",[u("& +",[c("button",{},[B(e+"-type",[F("border",{borderLeftWidth:d}),F("state-border",{left:Me})])])])])}function U(e){return B(e+"-type",[u("& +",[c("button",[B(e+"-type",[F("border",{borderTopWidth:d}),F("state-border",{top:Me})])])])])}const Bt=c("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
`,[be("vertical",{flexDirection:"row"},[be("rtl",[c("button",[u("&:first-child:not(:last-child)",`
 ...
 margin-right: ${d};
 border-radius: ${d};
 `),L("default"),B("ghost",[L("primary"),L("info"),L("success"),L("warning"),L("error")])])])]),B("vertical",{flexDirection:"column"},[c("button",[u("&:first-child:not(:last-child)",`
 margin-bottom: ${d};
 margin-left: ${d};
 margin-right: ${d};
 border-bottom-left-radius: ${d};
...
`,[u("&:first-child","margin-top: 0;"),u("&:last-child","margin-bottom: 0;")]),jt=Object.assign(Object.assign({},E.props),{depth:[String,Number]}),At=W({name:"P",props:jt,setup(e){const{mergedClsPrefixRef:n,inlineThemeDisabled:s}=Y(e),f=E("Typography","-p",Ot,De,e,n),o=Q(()=>{const{depth:b}=e,V=b||"1",{common:{cubicBezierEaseInOut:T},self:{pFontSize:h,pLineHeight:l,pMargin:x,pTextColor:C,[`pTextColor${V}Depth`]:v}}=f.value;return{"--n-bezier":T,"--n-font-size":h,"--n-line-height":l,"--n-margin":x,"--n-text-color":b===void 0?C:v}}),i=s?Re("p",Q(()=>`${e.depth||""}`),o,e):void 0;return{mergedClsPrefix:n,cssVars:s?void 0:o,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),p("p",{class:[`${this.mergedClsPrefix}-p`,this.themeClass],style:this.cssVars},this.$slots)}}),Lt=c("text",`
 transition: color .3s var(--n-bezier);
 color: var(--n-text-color);
`,[B("strong",`
